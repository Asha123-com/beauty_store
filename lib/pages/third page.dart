import 'package:beauty/data/details%20list.dart';
import 'package:beauty/google%20font.dart';
import 'package:beauty/pages/fourthpage.dart';
                    ...
                    children: [
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(image: AssetImage("assets/image/girl.jpg")),
                                ),
                              ),
                              SizedBox(width: 20,),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Dolphin", style: myStyle(30, BG2),),
                                  Text("nice@gmail.com", style: smallstyle(20, BG2),),
                                ],
                              ),
                            ],
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          scrollDirection: Axis.horizontal,
                          children: [
                            MainContainerbuild("Shine"), Gap(5),
                            MainContainerbuild("Gloss"), Gap(5),
                            MainContainerbuild("Spark"), Gap(5),
                            MainContainerbuild("Pure"), Gap(5),
                            MainContainerbuild("Beam"), Gap(5),
                            MainContainerbuild("Eyeshadow"), Gap(5),
                            MainContainerbuild("Foundation"), Gap(5),
                            MainContainerbuild("Matte"),
                          ],
                        ),
                      ),
                      ListView.builder(
